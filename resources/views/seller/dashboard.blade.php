...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Total Buyer</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalBuyer }}</div>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card border-left-danger shadow h-100 py-2 px-3">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Total Instrument</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalInstrument }}</div>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-secondary shadow h-100 py-2 px-3">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                ...
                <div class="card border-left-info shadow h-100 py-2 px-3">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Total Slide Show</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalSlideShow }}</div>
                            </div>
                            <div class="col-auto">
