            ...
            <div class="col-md-5">
                <div class="card p-3 shadow-lg">
                    ...
                    <div class="form-floating mb-3">
                        <input type="username" class="form-control" id="floatingInput" placeholder="namexxx">
                    ...
                    <button class="btn btn-primary mt-4 mb-3 p-3"><i class="fal fa-user-plus"></i> Daftar</button>
                    <p class="text-center">Sudah mendaftar? <a href="{{ route('login') }}">Masuk</a></p>
                    <div class="divider "><span>atau</span></div>
                    <a href="" class="btn btn-light p-3 mb-3"><i class="fab fa-google-plus-g text-danger"></i> Daftar
                        dengan Google
                    </a>
                </div>
            </div>
