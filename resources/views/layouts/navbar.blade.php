<nav class="navbar navbar-expand-lg bg-body-tertiary p-3">
    <div class="container-fluid">
        <a class="navbar-brand fs-4 text-light fw-bold" href="{{ route('home') }}"><img
                src="{{ asset('assets/images/logo.png') }}" class="rounded-circle img-thumbnail"
                style="width: 60px; height: 60px;" alt=""> Musicall<span class="text-warning">Instrument</span></a>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><i class="fas fa-music"></i> Musicall<span
                        class="text-warning">Instrument</span>
                </h5>
                ...
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link fs-6 {{ Request::is('instruments*') ? 'text-white' : 'text-secondary' }}"
                            aria-current="page" href="{{ route('/.instruments.index') }}"><i class="fal fa-music"></i>
                            Instruments</a>
                    </li>
                    @auth
                        <li class="nav-item">
                            <a class="nav-link fs-6 {{ Request::is('carts') ? 'text-white' : 'text-secondary' }}"
                                aria-current="page" href="{{ route('carts.index') }}">
                            ...
                            <ul class="dropdown-menu">
                                @if (Auth::user()->role === 'admin' || Auth::user()->role === 'seller')
                                    <li><a class="dropdown-item fs-6" href="{{ route('seller.dashboard') }}"><i
                                            ...
                                            Dashboard</a></li>
                                @else
                                    <li><a class="dropdown-item fs-6" href="{{ route('profile.index') }}"><i
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="nav-link active fs-6 text-secondary" aria-current="page"
                                href="{{ route('login') }}"><i class="fal fa-sign-in-alt"></i> Login</a>
                        </li>
                    @endguest
                </ul>
            </div>
